...
if [[ ${PV} == 9999 ]]; then
	inherit git-r3
	EGIT_REPO_URI="https://github.com/pythonlover02/DXVK-Sarek.git"
	EGIT_SUBMODULES=(
...
DESCRIPTION="Vulkan-based implementation of D3D9, D3D10 and D3D11 for Linux / Wine without needing Vulkan 1.3"
